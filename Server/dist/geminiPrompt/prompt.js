...
function run(question, table_name, metadata) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                ...
                throw new QueryGenerationError('Failed to initialize AI model', error instanceof Error ? error : new Error(error));
            }
            // Sanitize inputs
            const sanitizedQuestion = question.replace(/[^\w\s?.,-]/g, '');
            const sanitizedTableName = table_name.replace(/[^\w]/g, '');
            const sanitizedMetadata = (metadata === null || metadata === void 0 ? void 0 : metadata.replace(/[^\w\s{}",:.-]/g, '')) || '';
            const queryPrompt = `
    ...
    `;
            ...
            const result = yield Promise.race([responsePromise, timeoutPromise]);
            if (!result) {
